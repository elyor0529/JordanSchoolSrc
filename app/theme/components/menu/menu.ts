...
*/
    new Menu (300, 'ثوابت النظام', '/lookups', null, 'lookups',  null, true, 0),    
    new Menu (301, 'ثوابت النظام', '/lookups/index', null, 'lookup-index',  null, false, 300), 
    new Menu (302, 'أنواع الثوابت', '/lookups/lookuptype', null, 'lookuptype',  null, false, 300),
    new Menu (303,'المدارس','',null,'schools',null,true,0),
    new Menu (304, ' المدارس', '/schools/index', null, 'school-index',  null, false, 303),
    new Menu (305, ' الاقسام', '/sections/index', null, 'section-index',  null, false, 303),
    new Menu (306, ' الباصات', '/buses/index', null, 'bus-index',  null, false, 303),
    new Menu (307, ' تعريف الجولات', '/tours/index', null, 'tour-index',  null, false, 303),
    new Menu (308, '  الصفوف الدراسية', '/classes/index', null, 'classes-index',  null, false, 303),
    //Registration Menus
